...
echo "Modified by Spencer Peloquin, McChord C.S. CAP, Tacoma, WA"
echo "Last Modified on Tuesday, July 13, 2021, 3:44pm"
...
function transmission_bittorent() 
{
    apt-get remove transmission -y -qq
    clear
...
while [ "$running" = true ]
do
  echo -e 'Type the number of the option you choose (Type "exit" or "quit" to exit the program):\n1. HTOP (Task Manager)\n2. ClamAV (Anti-Virus)\n3. RKHunter (Anti-Rootkit)\n4. CHKRootkit (Anti-Rootkit)\n5. Unhide\n6. Lynis\n7. Bum (GUI for startup scripts and services)\n8. HardInfo'
  read answer
  clear
